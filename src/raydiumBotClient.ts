...
export async function TradeToken(
  ...
  try {
    ...
    // console.log("TradeToken called with parameters:", { rpcProvider, amount, tokenAddress, poolAddress, currencyType, tradeSide });
    // console.log("BotAddress:", BotAddress.toBase58());
    // console.log("TargetToken:", TargetToken.mint.toBase58());
    // console.log("Bot token accounts:", botTokenAccounts);
